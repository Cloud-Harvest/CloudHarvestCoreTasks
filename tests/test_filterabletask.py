...
#
#
# class TestBaseTaskChainFilterApplication(unittest.TestCase):
#     def setUp(self):
#         from CloudHarvestCoreTasks.dataset import DataSet
#
#         self.dataset = DataSet()
...
#         task_chain = task_chain_from_dict(template=self.task_chain, **self.config)
#
#         # Set var.my_dataset for testing
#         task_chain.variables['my_dataset'] = self.dataset
#
#         # Run the TaskChain
#         task_chain.run()
#
#         # Check the results are as expected
#         self.assertEqual(len(task_chain.result['data']), 2)
#         for key in ['name', 'address.state', 'dob']:
#             for record in task_chain.result['data']:
