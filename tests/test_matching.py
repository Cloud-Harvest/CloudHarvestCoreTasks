...
class TestHarvestMatch(unittest.TestCase):
    ...
    def test_HarvestMatch(self):
        ...
        record = WalkableDict({'key1': '1', 'key2': '2'})

        # Test '==' operator
        syntax = 'key1==1'
        match = DataSetMatch(syntax=syntax)
    ...
    def test_as_mongo_filter(self):
        # Test '=' operator
        match = DataSetMatch(syntax='key1=value1')
...
class TestHarvestMatchSet(unittest.TestCase):
    def test_as_mongo_filter(self):
        ...
        single_match_set = DataSetMatchSet(matches=['key1=value1'])
